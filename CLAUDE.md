...
An independent agent-native trading platform. Sooppiy is a standalone product.
...
- **DB:** SQLite by default (`service/server/data/sooppiy.db`), PostgreSQL in production (set `DATABASE_URL`).
